    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > AXI_DATA_pc_buffer(1843200);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 921600; j < e; j += 1, ++i) {
            ((char*)__xlx_apatb_param_in)[j] = AXI_DATA_pc_buffer[i].to_int64();
          }
            for (int j = 0, e = 921600; j < e; j += 1, ++i) {
            ((char*)__xlx_apatb_param_out)[j] = AXI_DATA_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_in)[j];
  ...
  __xlx_offset_byte_param_out = 921600*1;
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_out)[j];
  ...
  tcl_file.set_num(1843200, &tcl_file.AXI_DATA_depth);
