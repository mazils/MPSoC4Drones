...
__attribute__((sdx_kernel("image_processing", 0))) void image_processing(volatile char in[921600], volatile char out[921600]) {_ssdm_SpecArrayDimSize(in, 921600);_ssdm_SpecArrayDimSize(out, 921600);
